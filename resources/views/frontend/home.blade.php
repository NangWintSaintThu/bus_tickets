			...
			<div class="container">
				<div class="row">
					<div class="col-lg-7 order-md-last d-md-flex align-items-stretch">
						<div class="img w-100 img-2 mr-md-2" style="background-image: url({{asset('frontend/images/about.jpg')}};"></div>
						<div class="img w-100 img-2 img-overlay ml-md-2 p-4" style="background-image: url({{asset('frontend/images/about-2.jpg')}};">
    ...
    <section class="ftco-section ftco-portfolio">
    	...
    	<div class="container">
    		<div class="row no-gutters">
	  			...
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 order-md-last img js-fullheight" style="background-image: url({{asset('frontend/images/work-2.jpg')}};">
	  			...
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 img js-fullheight" style="background-image: url({{asset('frontend/images/work-3.jpg')}});">
	  			...
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 img js-fullheight" style="background-image: url({{asset('frontend/images/work-5.jpg')}});">
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
	          ...
	          <div class="block-7">
	          	<div class="img" style="background-image: url({{asset('frontend/images/work-1.jpg')}});"></div>
	            <div class="p-4">
	        ...
	        <div class="col-md-4 ftco-animate">
	          <div class="block-7">
	          	<div class="img" style="background-image: url({{asset('frontend/images/work-2.jpg')}});"></div>
	            <div class="p-4">
		            <ul class="pricing-text mb-2">
		              <li><span class="fa fa-check-circle mr-2"></span>Planning Solution</li>
		              <li><span class="fa fa-check-circle mr-2"></span>10 Construction Drawings</li>
	        ...
	        <div class="col-md-4 ftco-animate">
	          <div class="block-7">
	          	<div class="img" style="background-image: url({{asset('frontend/images/work-3.jpg')}});"></div>
	            <div class="p-4">
		            <ul class="pricing-text mb-2">
		              <li><span class="fa fa-check-circle mr-2"></span>Planning Solution</li>
		              <li><span class="fa fa-check-circle mr-2"></span>10 Construction Drawings</li>
