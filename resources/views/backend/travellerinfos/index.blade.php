                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="Width:100%;">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-lable="Name: activate to sort column descending" style="width: 58px;">Position</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-lable="Name: activate to sort column descending" style="width: 58px;">Office</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-lable="Name: activate to sort column descending" style="width: 58px;">Age</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-lable="Name: activate to sort column descending" style="width: 58px;">Start date</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-lable="Name: activate to sort column descending" style="width: 58px;">Salary</th>
                    </tr>
                  </thead>
                  <tfoot>
                    <tr>
